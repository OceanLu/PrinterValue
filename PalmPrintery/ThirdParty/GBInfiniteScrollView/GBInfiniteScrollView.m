...
- (void)addNextVisiblePage:(UIView *)page
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (void)addPreviousVisiblePage:(UIView *)page
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (void)addLastVisiblePage:(UIView *)page atIndex:(NSUInteger)index
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (void)addFirstVisiblePage:(UIView *)page atIndex:(NSUInteger)index
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (void)removeFirstVisiblePage
{
    ...
    UIView *firstVisiblePage = [self firstVisiblePage];
...
- (void)removeLastVisiblePage
{
    ...
    UIView *lastVisiblePage = [self lastVisiblePage];
...
- (void)updateData
{
    ...
    [self.visiblePages enumerateObjectsUsingBlock:^(UIView *visiblePage, NSUInteger idx, BOOL *stop)
    {
    ...
    if (currentpage) {
        ...
        [self.visibleIndices enumerateObjectsUsingBlock:^(NSNumber *visibleIndex, NSUInteger idx, BOOL *stop) {
            if (self.visiblePages.count>=idx) {
                UIView *visiblePage = [self.visiblePages objectAtIndex:idx];
...
- (void)movePage:(UIView *)page toPositionX:(CGFloat)positionX
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (void)movePage:(UIView *)page toPositionY:(CGFloat)positionY
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (void)placePage:(UIView *)page atPointX:(CGFloat)pointX
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (void)placePage:(UIView *)page atPointY:(CGFloat)pointY
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (CGFloat)placePage:(UIView *)page onRight:(CGFloat)rightEdge
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (CGFloat)placePage:(UIView *)page onBottom:(CGFloat)bottomEdge
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (CGFloat)placePage:(UIView *)page onLeft:(CGFloat)leftEdge
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
...
- (CGFloat)placePage:(UIView *)page onTop:(CGFloat)topEdge
{
    if (self.isDebugModeOn && self.isVerboseDebugModeOn) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
