...
#define kHorizontalPadding          35.0
#define kVerticalPadding            14.0
...
//    NSLog(@"%f,%f",toastPoint.x,toastPoint.y);
    [toast setAlpha:kToastAlpha];
...
//        [titleLabel setLineBreakMode:UILineBreakModeWordWrap]; //default
        [titleLabel setTextColor:[UIColor whiteColor]];
        [titleLabel setBackgroundColor:[UIColor clearColor]];
        [titleLabel setAlpha:kToastAlpha];
...
//        [messageLabel setLineBreakMode:UILineBreakModeWordWrap]; //default value
        [messageLabel setTextColor:[UIColor whiteColor]];
        [messageLabel setBackgroundColor:[UIColor clearColor]];
        [messageLabel setAlpha:kToastAlpha];
